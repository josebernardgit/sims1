<div class="container widgets">
	...
	<div class="subnav subnav-fixed">
	  <ul class="nav nav-pills">
	    <li class="active"><a href="<?php echo current_url(); ?>">Create Role</a></li>
			...
			<form name="frmRoles" id="frmRoles" action="" method="post" class="form-horizontal">
				<fieldset>
					...
					<div class="control-group" id="groupModule">
						...
						<div class="controls">
							<select name="module" id="module" class="input-xlarge">
								...
								?>
											<option value="<?php echo $indexModules['id']; ?>"><?php echo $indexModules['module_name']; ?></option>
								<?php
										}
									}
								?>
					...
					<div class="control-group" id="groupRoleName">
						...
						<div class="controls">
							<input type="text" name="roleName" id="roleName" value="" class="input-xlarge"/>
					...
					<div class="control-group" id="groupRoleDescription">
						...
						<div class="controls">
							<textarea name="roleDescription" id="roleDescription" class="input-xlarge" rows="3"></textarea>
	...
	(
		function()
		{
			...
			if(formError == 1){
				...
				$.post
				(
					'<?php echo site_url('admin/roles/save'); ?>',
					{
						module: $('#module').val(),
					...
					function(data)
					{
						...
						if(data == 'EXIST'){
							...
							$('#messageContent').html('There was an error found in saving the Module Information.');
							$('#message').addClass('alert-error');
							$('#message').fadeIn('slow');
						} else if(data == 'SAVE'){
							$('#messageContent').html('Role Information successfully saved.');
