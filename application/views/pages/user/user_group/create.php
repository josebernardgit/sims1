<div class="container widgets">
	...
	<div class="subnav subnav-fixed">
	  <ul class="nav nav-pills">
	    <li class="active"><a href="<?php echo current_url(); ?>">Create User Group</a></li>
			...
			<form name="frmUserGroup" id="frmUserGroup" action="" method="post" class="form-horizontal">
				<fieldset>
					...
					<div class="control-group" id="groupUserGroup">
						...
						<div class="controls">
							<input name="userGroup" id="userGroup" class="input-xlarge" type="text">
					...
					<div class="control-group" id="groupUserGroupDescription">
						...
						<div class="controls">
							<textarea name="userGroupDescription" id="userGroupDescription" class="input-xlarge" rows="3"></textarea>
	...
	(
		function()
		{
			...
			if(formError == 1){
				...
				$.post
				(
					'<?php echo site_url('user/user_group/save'); ?>',
					{
					...
					function(data)
					{
						...
						if(data == 'EXIST'){
							...
							$('#messageContent').html('There was an error found in saving the User Group Information.');
							$('#message').addClass('alert-error');
							$('#message').fadeIn('slow');
						} else if(data == 'SAVE'){
							$('#messageContent').html('User Group Information successfully saved.');
